...
@"                    //Templated subcontrol for " + PROPERTY_IDENTIFIER + @"
                    ...
                    " + TEMPLATE_BUILDER_NAME + @".AddAttribute(" + SUB_CONTROL_LINE_INDEX + @", ""Value"", global::Microsoft.AspNetCore.Components.CompilerServices.RuntimeHelpers.TypeCheck<" + PROPERTY_TYPE + @">(Value." + PROPERTY_IDENTIFIER + @"));" + TEMPLATED_SUB_CONTROL_PASS_ATTRIBUTES + @"
...
" + TEMPLATE + @"
			...
			public String Build()
			{
				...
				var templatedSubControlPassAttributes = _subControlPassAttributesTemplate
					.Build()
				...
				var template = (String.IsNullOrEmpty(_templateType) ?
								...
								TEMPLATED_TEMPLATE
									.Replace(SUB_CONTROL_PASS_ATTRIBUTES, subControlPassAttributes)
									.Replace(TEMPLATED_SUB_CONTROL_PASS_ATTRIBUTES, templatedSubControlPassAttributes)
