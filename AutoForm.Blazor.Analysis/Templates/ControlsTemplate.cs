...
namespace AutoForm.Generate.Blazor.Templates
{
	internal sealed partial class SourceFactory
	{
		...
		{
			private ControlsTemplate(IEnumerable<KeyValueTypesPairTemplate> modelControlPairTemplates, IEnumerable<KeyValueTypesPairTemplate> modelTemplatePairTemplates, IEnumerable<ControlTemplate> controlTemplates, DefaultControlsTemplate defaultControlsTemplate)
			{
				_defaultControlsTemplate = defaultControlsTemplate;
				_modelControlPairTemplates = modelControlPairTemplates;
				_modelTemplatePairTemplates = modelTemplatePairTemplates;
			...
			private readonly IEnumerable<KeyValueTypesPairTemplate> _modelTemplatePairTemplates;
...
#pragma warning restore 1591";
			...
			{
				return new ControlsTemplate(modelControlPairTemplates, _modelTemplatePairTemplates, _controlTemplates, _defaultControlsTemplate);
			}
			public ControlsTemplate WithModelTemplatePairTemplates(IEnumerable<KeyValueTypesPairTemplate> modelTemplatePairTemplates)
			{
				return new ControlsTemplate(_modelControlPairTemplates, modelTemplatePairTemplates, _controlTemplates, _defaultControlsTemplate);
			}
			public ControlsTemplate WithControlTemplates(IEnumerable<ControlTemplate> controlTemplates)
			{
				return new ControlsTemplate(_modelControlPairTemplates, _modelTemplatePairTemplates, controlTemplates, _defaultControlsTemplate);
			}
