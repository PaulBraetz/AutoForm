...
namespace AutoForm.Blazor
{
	...
	public sealed class AutoControl<TModel> : ControlBase<TModel>
	{
		...
		private void RenderSubControl(RenderTreeBuilder builder)
		{
			...
			builder.AddAttribute(6, "ValueChanged", RuntimeHelpers.TypeCheck(EventCallback.Factory.Create<TModel>(this, RuntimeHelpers.CreateInferredEventCallback(this, __value => { Value = __value; _ = ValueChanged.InvokeAsync(Value); }, Value))));
