...
namespace AutoForm.Analysis
{
	internal readonly struct ModelExtractor
	{
		...
		//    var modelTypes = GetTypeArguments(typeDeclaration.AttributeLists, typeDeclaration, Attributes.FallbackControl);
		...
		//    {
		//        if (TryGetAttributes(declaration.AttributeLists, declaration, Attributes.FallbackControl, out var _))
		//        {
